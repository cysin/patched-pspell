The 'pspell' PHP extension offers only few functions to customize. This patch added 'pspell\_config\_set' function so that you can set any options you want.
